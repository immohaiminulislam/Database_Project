...
<body>
	<div id="header"><br>
		<center>Go Cart Race &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Email: <?php echo $_SESSION['email'];?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Name:<?php echo $_SESSION['name'];?> 
		...
		<form action="" method="post">
			<table>
				...
				<tr>
					<td>
						<input type="submit" name="show_all_player" value="Show All Player">
					</td>
				</tr>
			</table>
		</form>
		...
		<!-- #Code for search player---Start-->
			<?php
				if(isset($_POST['search_player']))
				{
					...
					<center>
					<form action="" method="post">
					&nbsp;&nbsp;<b>Enter Player ID No:</b>&nbsp;&nbsp; <input type="text" name="id_no">
					<input type="submit" name="search_by_id_no_for_search" value="Search">
					</form><br><br>
					<h3><b><u>Player's details</u></b></h3><br><br>
					</center>
					<?php
				}
				...
				while ($row = mysqli_fetch_assoc($query_run)) 
				{
					...
					<form action="admin_edit_player.php" method="post">
						...
						<tr>
							...
							<td>
								<textarea rows="3" cols="40" name="comment"><?php echo $row['remark']?></textarea>
							</td>
						</tr><br>
						<tr>
							<td></td>
		...
		<?php
			...
			<?php 
				if(isset($_POST['add_new_player'])){
					?>
					<center><h4>Give Info to add new player</h4></center>
